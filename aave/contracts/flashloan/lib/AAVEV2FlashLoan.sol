...
library AAVEV2FlashLoan {
    ...
    function takeFlashLoan(address[] memory tokens, uint256[] memory amounts) internal {
        ...
        require(address(contextOne.AAVEPool) != address(0), "AAVEV2Flashloan: Query to AAVElendingPool failed.");
    ...
    function takeFlashLoan(address token, uint256 amount) internal {
        ...
        require(address(contextTwo.AAVEPool) != address(0), "AAVEV2Flashloan: Query to AAVElendingPool failed.");
    ...
    function payFlashLoan(bytes calldata data) internal {
        ...
        require(msg.sender == address(contextThree.AAVEPool), "AAVEV2FlashLoan: Callback msg.sender was not the pool");
